...
const PARKS: readonly Park[] = [
  ...
  {
    key: 'altindere-milli-park',
    title: 'Altındere Vadisi Milli Parkı',
    description: 'Doğa yürüyüşleri ve milli park alanı',
    tags: ['Milli Park', 'Doğa', 'Vadi'],
    image: require('../assets/places/altindere-park.jpg'),
    mapUrl: 'https://share.google/ing9KoBdb4xZYByyu',
    transport: {
      kind: 'two',
      dolmusText: 'Moloz - Sümela dolmuşları kullanılabilir.',
      otobusText:
        '451 numaralı belediye otobüsü kullanılarak 6587 - Maçka Belediyesi durağında inilebilir. Buradan hareket eden Sümela minibüsleri kullanılabilir.',
    },
    visitBullets: [
      'Milli park girişleri ve güncel ücretler döneme göre değişebilir; giriş noktası bilgisini kontrol edin.',
      'Yürüyüş ve eğimli parkurlar için rahat ayakkabı önerilir.',
    ],
  },
] as const;
