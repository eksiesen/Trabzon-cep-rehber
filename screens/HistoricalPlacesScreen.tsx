...
const HISTORICAL_PLACES: readonly HistoricalPlace[] = [
  {
    key: 'sumela-manastiri',
    title: 'Sümela Manastırı',
    description: 'Trabzon’un en ikonik tarihi yapılarından biri',
    shortInfo:
      'Sümela Manastırı’nın Bizans İmparatoru I. Theodosius döneminde Atina’dan gelen rahipler Barnabas ve Sophronios tarafından kurulduğu düşünülmektedir. Manastırın kuruluşu, Aziz Lukas’ın yaptığı kabul edilen kutsal Panagia Soumela ikonasıyla ilgili efsanelere dayanmaktadır. Trabzon Komnenosları döneminde genişletilen yapı, Osmanlı döneminde de korunmuş; Fatih Sultan Mehmet ve Yavuz Sultan Selim tarafından desteklenmiştir. 19. yüzyılda en parlak dönemini yaşayan manastır, 1923 sonrası boşaltılmıştır.',
    tags: ['Tarih', 'Manastır', 'Doğa'],
    image: require('../assets/places/sumela.jpg'),
    mapUrl: 'https://maps.app.goo.gl/foGXiCSCiMmCr2qn9',
    museumCard: {
      title: 'Müzekart',
    ...
    transport: {
      kind: 'two',
      dolmusText: 'Moloz - Sümela dolmuşları kullanılabilir.',
      otobusText:
        '451 numaralı belediye otobüsü kullanılarak 6587 - Maçka Belediyesi durağında inilebilir. Buradan hareket eden Sümela minibüsleri ile manastır bölgesine ulaşım sağlanabilir.',
    },
  },
  {
