...
const POPULAR_STOPS = [
  { key: 'moloz-uzungol', title: 'Moloz - Uzungöl', blurb: 'Tur durağı' },
  { key: 'moloz-sumela', title: 'Moloz - Sümela', blurb: 'Tur durağı' },
  { key: 'moloz-hamsikoy', title: 'Moloz - Hamsiköy', blurb: 'Tur durağı' },
  { key: 'moloz-akcaabat', title: 'Moloz - Akçaabat', blurb: 'İlçe hattı' },
  ...
  { key: 'tanjant-boztepe', title: 'Tanjant - Boztepe', blurb: 'Merkez hattı' },
] as const;
...
export function TransportScreen() {
  ...
  React.useEffect(() => {
    ...
    if (incoming) setDetailKey(incoming);
